...
export class FavoritesComponent extends DrawerPage implements OnInit {
    ...
    constructor(private favoriteservice: FavoriteService, private changeDetectorRef: ChangeDetectorRef, @Inject('BaseURL') private BaseURL) {
        super(changeDetectorRef);
    }

    ngOnInit() {
        this.favoriteservice.getFavorites()
            .subscribe(favorites => this.favorites = new ObservableArray<Dish>(favorites), errmess => this.errMess = errmess);
    }
                ...
                if (result) {
                    ...
                    this.favoriteservice.deleteFavorite(id)
                        .subscribe(favorites => {
                            ...
                            toast.show();
                            this.favorites = new ObservableArray<Dish>(favorites);
